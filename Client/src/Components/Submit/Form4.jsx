            ...
            <form>
                <Flex mt="25px" gap="20px"  >
                    ...
                    <Box>
                        ...
                        <Text textAlign="justify" fontSize="14px" lineHeight="24px" fontWeight="400">We welcome you to the AI ZONES Creators world. If you have logged in with your official tools domain registered email, our team will automatically send you a verification link. Upon successful verification, you will be granted access to the "Creators Portal" where you can regularly update your tools details and leverage our exciting features. If you haven't used your official registered domain email, no worries! Simply sign up using your official registered email, and once your tool is live on AI ZONES, you can request access to the Creators Portal, where our team will verify and provide access. Thank you for your contribution!</Text>
                    </Box>
