...
const Collect = ({ id, el }) => {
    ...
    return (
        <>
            ...
            <Button onClick={onOpen}  w="194px" h="36px" mt="20px" borderRadius="5px" border="1px" borderColor={useColorModeValue("#E6E6E6", "#444")} fontSize="14px" fontWeight="400" gap="5px"   background={"transparent"}><HiOutlineBookmark /> Collect</Button>
